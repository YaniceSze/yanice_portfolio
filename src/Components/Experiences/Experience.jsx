                ...
                <div className="w-full md:w-1/2 p-4">
                  ...
                  <div className="flex flex-wrap -m-3">
                    <div className="flex flex-wrap items-center w-auto p-3">
                      ...
                      <p className="text-gray-500 font-bold">{experience.employmentType}</p>
                    </div>
                    <div className="flex flex-wrap items-center w-auto p-3">
                      <svg className="mr-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className="text-gray-500 font-bold">{experience.location}</p>
                    </div>
                    <div className="flex flex-wrap items-center w-auto p-3">
                      <svg className="mr-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className="text-gray-500 font-bold">{experience.duration}</p>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-1/2 p-4">
